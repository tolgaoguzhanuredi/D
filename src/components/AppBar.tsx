            ...
            <svg width="100%" height="22" viewBox="0 0 646 96" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <linearGradient id="paint0_linear_1064_606" x1="10.81" y1="98.29" x2="98.89" y2="-1.01005" gradientUnits="userSpaceOnUse">
                  <stop offset="0.08" stopColor="#CD5C5C" />
                  <stop offset="0.3" stopColor="#F08080" />
                  <stop offset="0.5" stopColor="#FA8072" />
                  <stop offset="0.6" stopColor="#E9967A" />
                  <stop offset="0.72" stopColor="#FFA07A" />
                  <stop offset="0.97" stopColor="#FF5733" />
                </linearGradient>
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className='flex flex-row'>
            ...
            <div className='my-auto'>
              {wallet && <p>Snoop Points: {(balance || 0).toLocaleString()}</p>}
            </div>
          </div>
        </div>
